...
angular.module('WordApp', ['ionic', 'WordApp.controllers', 'WordApp.services', 'WordApp.filters', 'WordApp.translate', 'WordApp.directives', 'WordApp.config', 'angular-cache', 'angularMoment', 'ionicLazyLoad'])

.run(function($ionicPlatform, $state, ONESIGNAL_APP_ID, GOOGLE_PROJECT_NUMBER, LNG_TOAST_BACK_BUTTON, LNG_SHARE_BUTTON, $rootScope, $ionicHistory) {
        ...
        var notificationOpenedCallback = function(jsonData) {
            ...
            if (jsonData.additionalData) {
                if (jsonData.additionalData.actionSelected == "id2" && jsonData.additionalData.postid && jsonData.additionalData.sharelink)
                    window.plugins.socialsharing.share('' + LNG_SHARE_BUTTON + ' ', null, null, jsonData.additionalData.sharelink);
            }
        }
